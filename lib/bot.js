...
Bot.prototype = {
  ...
  getArticleInfo( title, options, callback ) {
    ...
    if ( typeof title === 'string' ) { title.push( title ); }
    if ( typeof title === 'number' ) { title.push( title ); }
    if ( typeof title === 'object' ) { title = Object.values( title ); }
    title.forEach( t => {
      if ( typeof t === 'string' ) { params.titles.push( t ); }
      if ( typeof t === 'number' ) { params.pageids.push( t ); }
    } );
