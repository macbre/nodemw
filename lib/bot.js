...
module.exports = (function() {
	...
	bot.prototype = {
		...
		sendEmail: function(username, subject, text, callback) {
			var self = this;
		...
		getMediaWikiVersion: function(callback) {
